...
WindowPropertyBuilder::WindowPropertyBuilder()
...
PropertyList WindowPropertyBuilder::getObjectProperties()
{
  return properties;
}

bool WindowPropertyBuilder::isObjectMatchFilter(const SearchÑriteriaData& data, rengaapi::ModelObject* pObject)
{
