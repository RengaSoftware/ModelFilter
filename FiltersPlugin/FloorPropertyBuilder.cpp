...
FloorPropertyBuilder::FloorPropertyBuilder()
...
PropertyList FloorPropertyBuilder::getObjectProperties()
{
  return properties;
}
bool FloorPropertyBuilder::isObjectMatchFilter(const SearchÑriteriaData& data, rengaapi::ModelObject* pObject)
{
